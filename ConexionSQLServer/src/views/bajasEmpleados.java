 ...
 */
public class bajasEmpleados extends javax.swing.JFrame {
    ...
    public void showEmpBajas(){
        DefaultTableModel cliente = (DefaultTableModel) tableShowPersonalData.getModel();
        cliente.setRowCount(0);
        res = conexionsqlserver.ConnectionDB.Query("select * from empleado where activo="+0);
    ...
    private void initComponents() {
        ...
        setTitle("Bajas administrativas de empleados");
        ...
        jLayeredPane1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Empleados dados de baja", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI Light", 0, 14), new java.awt.Color(255, 51, 51))); // NOI18N
    ...
    private void btnHabilitarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHabilitarActionPerformed
        ...
        int opt = JOptionPane.showConfirmDialog(this, "¿Estás seguro de habilitar éste empleado?" , "¿Confirmar?", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        ...
        if( opt == JOptionPane.NO_OPTION ){
            ...
            try{
                storedProcedures.enableEmpleado(getCod());
                JOptionPane.showMessageDialog(null, "Empleado habilitado exitosamente!!" , "Genial", JOptionPane.INFORMATION_MESSAGE);
                this.showEmpBajas();
                this.cleanAddress();
                this.cleanEmail();
                this.cleanTel();
    ...
    private void refreshActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_refreshActionPerformed
        ...
        this.tableHorario.clearSelection();
        this.showEmpBajas();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bajasEmpleados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new bajasEmpleados().setVisible(true);
            }
        });
    }
